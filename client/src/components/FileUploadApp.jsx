...
function FileUploadApp() {
  ...
  return (
    <div>
      <div>
        <h1>
          File Upload App (WebSocket)<span>{status}</span>
        </h1>
      </div>
      <input
        type="text"
        placeholder="Enter name"
        onChange={(e) => setFileType({ ...fileType, name: e.target.value })}
      />
      <input
        type="text"
        placeholder="Enter pages"
        onChange={(e) => setFileType({ ...fileType, pages: e.target.value })}
      />
      <input
        type="number"
        placeholder="Enter pages per sheet"
        onChange={(e) =>
          setFileType({ ...fileType, pagePerSheet: e.target.value })
        }
      />
      <select
      ...
      <input
        ...
        onChange={(e) => setFileType({ ...fileType, flip: e.target.checked })}
      />
